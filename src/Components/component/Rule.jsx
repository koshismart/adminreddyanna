...
const RuleModal = ({ onClose }) => {
  ...
  return (
    <div className="modal fade show d-block" style={{ position: "absolute", zIndex: 1040 }}>
      <div
        id="__BVID__31"
        role="dialog"
            ...
            <div className="modal-body">
              <div className="main-rules-container">
                <div className="dropdown rules-language-container">
                  ...
                  >
                    <img src="https://g1ver.sprintstaticdata.com/v79/static/admin/img/flag_english.png" />
                    English
                    <i className="fas fa-angle-down ml-1" />
                  </div>{" "}
                  <div className="dropdown-menu rules-language" style={{}}>
                    <div>
                      <img src="https://g1ver.sprintstaticdata.com/v79/static/admin/img/flag_english.png" />{" "}
                      <span>English</span>
                    </div>
                ...
                <div className="menu-box">
                  <div id="accordion">
                        ...
                        <div id="eventaccordion0" className="card-body">
                          ...
                          <div className="card">
                            ...
                            >
                              ...
                              <div className="rule-text text-danger">
                                “In the event of a technical error or any
                                unforeseen circumstance that leads to the
                                suspension of the Provider’s side of any market
                                (Match_Odds,Over/Under, etc.) during a sporting
                                event, and the market does not resume, the
                                outcome will be settled based on the current
                                result (win/loss) at the time of suspension. All
                                bets placed prior to suspension will remain
                                valid and will be settled accordingly. The
                                company assumes no responsibility or liability
                                for such interruptions or outcomes.”
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div id="eventaccordion1" className="card-body">
                          <div className="card">
                            ...
                            >
                              ...
                              <div className="rule-text">
                                Our's non-runner rule relates to the adjustment
                                ...
                                below) of that horse's chances of winning (or
                              ...
                              <div className="rule-text">
                                ...
                                factor percentage for each horse can be viewed
                                on the 'info' page on Our website or by asking
                                the Helpdesk.
                              </div>
                              <div className="rule-text">
                              ...
                              <div className="rule-text">
                                ...
                                the non-runner's reduction factor is less than
                              ...
                              <div className="rule-text">
                                ...
                                reduced by an amount equal to the non-runner's
                              ...
                              <div className="rule-text">
                                ...
                                brought to Our's attention. If We becomes aware
                              ...
                              <div className="rule-text">
                                ...
                                non-runner's final reduction factor is 25% the
                              ...
                              <div className="rule-text">
                                ...
                                example: if the non-runner's final reduction
                          ...
                          <div className="card">
                            ...
                            >
                              <div className="rule-text">
                                ...
                                individual match will be void.after completion
                                of 1st set in case of retirement the opponent
                                player will be given the winner for match winner
                                bets.
                              </div>
                              <div className="rule-text">
                              ...
                              <div className="rule-text text-danger">
                                ...
                                unforeseen circumstance that leads to the
                                suspension of the Provider’s side of any market
                                (Match_Odds,Over/Under, Game Winner, Point
                                Winner, etc.) during a sporting event, and the
                                market does not resume, the outcome will be
                                settled based on the current result (win/loss)
                                at the time of suspension. All bets placed prior
                                to suspension will remain valid and will be
                                settled accordingly. The company assumes no
                                responsibility or liability for such
                                interruptions or outcomes.”
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      >
                        <div id="eventaccordion9" className="card-body">
                          <div className="card">
                            ...
                            >
                              <div className="rule-text">
                                Match_Odds:-Predict which player will win the
                                ...
                                starting but not being completed, then all bets
                                will be void.
                              </div>
                              <div className="rule-text">
                                Set Winner:-The Set must be completed for bets
                                to stand, unless the specific market outcome is
                                already determined.
                              </div>
                              <div className="rule-text text-danger">
                                Company reserves the right to suspend/void any
                      ...
                      >
                        <div id="eventaccordion32" className="card-body">
                          <div className="card">
                            ...
                            >
                              <div className="rule-text">
                                1. In any circumstances management decision will
                                be final related to all Fancy of kabaddi of our
                                exchange.
                              </div>
                              <div className="rule-text">
                                2. All fancy bets will be validated when match
                                has been tied.
                              </div>
                              <div className="rule-text">
                                3. Result of individual player of fancy will be
                                validated only when player play that match.
                              </div>
                              <div className="rule-text">
                                4. In any case wrong rate has been given in
                                fancy that particular bets will be deleted.
                              </div>
                              <div className="rule-text">
                                5. Final Result Of 40 Minutes Of Two Halves Will
                              ...
                              <div className="rule-text">
                                7. If any player will get injured during the
                                match, then all the bets will be valid of that
                                individual player
                              </div>
                            </div>
                          </div>
                          <div className="card">
                            ...
                            >
                              <div className="rule-text">
                                In case, company will find Ground bets, Group
                                betting, Punching bets, Multiple entries with
                                same IP or any fraud or unusual activities are
                                detected then Company will be void winning bets
                                and charge penalty of 2X (Two times) from
                              ...
                              <div className="rule-text">
                                Final Result Of 40 Minutes Of Two Halves Will Be
                                Valid In Our Exchange
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="card">
                      <div id="eventhead35" className="card-header">
                        <a
                          href="javascript:void(0)"
                          data-toggle="collapse"
                          data-target="#event35"
                          aria-controls="event35"
                          className=""
                          aria-expanded="true"
                        >
                          Beach Volleyball
                      ...
                      <div
                        id="event35"
                        aria-labelledby="eventhead35"
                        data-parent="#accordion"
                        className="collapse show"
                        style={{}}
                      >
                        <div id="eventaccordion35" className="card-body">
                          <div className="card">
                            <div className="card-header">
                              <a
                                href="javascript:void(0)"
                                data-toggle="collapse"
                                data-target="#event35game0"
                                className="collapsed"
                                aria-expanded="false"
                              >
                                match
                    ...
                    <div className="card">
                      <div id="eventhead36" className="card-header">
                        <a
                          href="javascript:void(0)"
                          data-toggle="collapse"
                          data-target="#event36"
                          aria-controls="event36"
                          className="collapsed"
                        >
                          Table Tennis
                        </a>
                      ...
                      <div
                        id="event36"
                        aria-labelledby="eventhead36"
                        data-parent="#accordion"
                        className="collapse"
                      >
                        <div id="eventaccordion36" className="card-body">
                          <div className="card">
                            <div className="card-header">
                              <a
                                href="javascript:void(0)"
                                data-toggle="collapse"
                                data-target="#event36game0"
                                className="collapsed"
                              >
                                match
                              </a>
                    ...
                    <div className="card">
                      <div id="eventhead37" className="card-header">
                        <a
                          href="javascript:void(0)"
                          data-toggle="collapse"
                          data-target="#event37"
                          aria-controls="event37"
                          className="collapsed"
                        >
                          Futsal
                        </a>
                      ...
                      <div
                        id="event37"
                        aria-labelledby="eventhead37"
                        data-parent="#accordion"
                        className="collapse"
                      >
                        <div id="eventaccordion37" className="card-body">
                          <div className="card">
                            <div className="card-header">
                              <a
                                href="javascript:void(0)"
                                data-toggle="collapse"
                                data-target="#event37game0"
                                className="collapsed"
                              >
                                match
                              </a>
              ...
              <div className="row row5 mt-3 align-items-center">
                <div className="col-7">I have read above rules</div>{" "}
