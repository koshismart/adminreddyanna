    ...
    <>
      ...
      {!bet && (
        <div className="flex relative w-full h-full gap-1">
          ...
          <div className="ball-by-ball goal casino-detail detail-page-container position-relative">
          ...
          <div className="casino-remark mt-1">
            <div className="remark-icon">
              <img src="https://g1ver.sprintstaticdata.com/v80/static/front/img/icons/remark.png" />
            </div>
              ...
              <div className="text-center">
                {(() => {
                  ...
                  return (
                    ...
                    <img src="https://g1ver.sprintstaticdata.com/v80/static/front/img/balls/soccer-ball.png" />
                    <span>{goalType} by {player}</span>
                  </div>
