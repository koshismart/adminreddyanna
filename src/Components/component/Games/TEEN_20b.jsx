...
const resultData = [
  { label: "Winner", value: "Player A" },
  { label: "3 Baccarat", value: "Player B (High Baccarat)" },
  { label: "", value: "(A : 2 | B : 4)" },
  { label: "Total", value: "Player A (A : 22 | B : 14)" },
  { label: "Pair Plus", value: "A : Pair" },
  { label: "Red Black", value: "A : Black | B : Red" }
];
