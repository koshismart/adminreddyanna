            ...
            <div className={`up-box ${isUpSuspended ? "suspended-box" : ""}`}>
                ...
                {isUpSuspended ? (
                    ...
                    <div className="text-end">
                        ...
                        <span className="block text-[15px] leading-3">UP</span>
                    </div>
                )}
            </div>
            ...
            <div className={`down-box ${isDownSuspended ? "suspended-box" : ""}`}>
                ...
                {isDownSuspended ? (
                    ...
                    <div className="text-start">
                        ...
                        <span className="block text-[15px] leading-3">DOWN</span>
                    </div>
                )}
            </div>
...
{(() => {
const upItem = oddsData.find((item) => item.sid === "5");
const downItem = oddsData.find((item) => item.sid === "6");
        ...
        <>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div className="text-center">
                    <h4 className="result-title font-bold text-lg">Player</h4>
                    ...
                    <div className="casino-result-cards flex justify-center gap-2 mt-2 relative">
                        ...
                        {individualResultData?.win == "1" && (
                            <div className="mt-4 casino-winner-icon relative right-0 top-1/2 -translate-y-1/2">
                ...
                {/* DEALER CARD */}
                <div className="text-center">
                    <h4 className="result-title font-bold text-lg">Dealer</h4>
