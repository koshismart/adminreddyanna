...
const TEEN_120 = ({
    ...
    const handleItemSelect = (betDataConfig) => {
        setPlaceBet(true);
        const newBetData = {
            ...
            {!bet && (
                <div className="flex relative w-full h-full gap-1">
                    <div className="center-container">
                        ...
                        <div className="onecard20 casino-video">
                            <div className="casino-table">
                                <div className="casino-table-full-box">
                                    {oddsData
                                        .filter((v) => v.sid === "1")
                                        .map((item) => (
                                            <div key={item.sid} className="onecard20oddbox onecard20player">
                                    ...
                                    {oddsData
                                        ...
                                        .map((item, index) => (
                                            <div className="onecard20oddbox onecard20dealer">
                                                <div className="casino-odds text-center">
                                                    {remainingTime <= 3 || item.gstatus === "SUSPENDED" ? "0" : item.b1}</div>
                                                {remainingTime <= 3 || item.gstatus === "SUSPENDED" ? (
                                                    <div className="casino-odds-box back casino-odds-box-theme suspended-box">
                                                        <span className="casino-odds">{item.nat}</span>
                                                    </div>
