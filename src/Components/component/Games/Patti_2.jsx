...
<div className="teenpatti2cards casino-detail">
    ...
    {oddsData
        ...
        .map((item, index) => (
            <div className="casino-table-row ">
                ...
                <div className={`casino-odds-box back  ${remainingTime <= 3 || item.gstatus == "SUSPENDED"
                        ? "suspended-box"
                        : ""
                    }`}
                >
                ...
                <div className={`casino-odds-box lay  ${remainingTime <= 3 || item.gstatus == "SUSPENDED"
                        ? "suspended-box"
                        : ""
                    }`}>
                    {remainingTime <= 3 || item.gstatus == "SUSPENDED" ? (
...
.filter((v) => v.sid === "7")
.map((item, index) => (
<div className="casino-table-full-box color-plus my-2" key={index}>
