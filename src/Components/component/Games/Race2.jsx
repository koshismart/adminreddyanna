             ...
             <div className="casino-table">
                <div className="casino-table-box">
                   {oddsData
                        ...
                        ?.map((item, idx) => (
                            <div className="casino-odd-box-container" key={idx}>
                        ...
                        <div className="casino-result-modal">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                            ...
                            {["Player A", "Player B", "Player C", "Player D"].map((p, i) => {
                              const cardsArr = individualResultData?.cards?.split(",") || [];
                              const cardCode = cardsArr[i]; // exact card per player
                              const cardImg = cardsData.find((v) => v.code === cardCode)?.image;

                              return (
                                <div className="text-center" key={i}>
                                  <h4 className="result-title font-bold text-lg">{p}</h4>
                                  ...
                                  <div className="casino-result-cards flex justify-center gap-2  mt-2 relative">
                                    ...
                                    {individualResultData?.win == (i + 1).toString() && (
                            ...
                            <div className="col-md-6">
                              <div className="casino-result-desc">
                                <div className="casino-result-desc-item">
                                  <div>Winner:</div>
                                  <div>
                                    {["Player A", "Player B", "Player C", "Player D"][individualResultData?.win - 1]}
                                  </div>
                                </div>
                              </div>
                            </div>
