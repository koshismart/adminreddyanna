                      ...
                      <div className="casino-table-body">
                        ...
                        >
                          ...
                          <div
                           ...
                           onClick={() => {
                            const playerA = casinoData?.data?.data?.data?.t2?.find(
                              (item) => item.sid === "1"
                            );

                            if (remainingTime > 3 && playerA?.gstatus !== "SUSPENDED") {
                              setPlaceBet(true);
                        ...
                        >
                          ...
                          <div
                            ...
                            onClick={() => {
                              ...
                              if (
                                remainingTime > 3 &&
                                playerASpade?.gstatus !== "SUSPENDED"
                              ) {
                                setPlaceBet(true);
                                const newBetData = {
                                  betName: playerASpade?.nat,
                                  boxColor: "bg-[#72bbef]",
                                  matchOdd: playerASpade?.b1,
                                  stake: 0,
                                  mid: cardData?.[0]?.mid,
                                  sid: playerASpade?.sid,
                                  oddType: "casino_odds",
                                  oddCategory: "Back",
                                };
                                setBetData(newBetData);
                        ...
                        >
                          ...
                          <div
                            ...
                            onClick={() => {
                              ...
                              if (
                                remainingTime > 3 &&
                                playerBSpade?.gstatus !== "SUSPENDED"
                              ) {
                                setPlaceBet(true);
                                const newBetData = {
                                  betName: playerBSpade?.nat,
                                  boxColor: "bg-[#72bbef]",
                                  matchOdd: playerBSpade?.b1,
                                  stake: 0,
                                  mid: cardData?.[0]?.mid,
                                  sid: playerBSpade?.sid,
                                  oddType: "casino_odds",
                                  oddCategory: "Back",
                                };
                                setBetData(newBetData);
                    ...
                    <div className="casino-table-body">
                      ...
                      <div className="casino-table-row">
                        ...
                        {[1, 2, 3, 4, 5, 6].map((cardNumber) => {
                          const cardData =
                            casinoData?.data?.data?.data?.t2?.find(
                              (item) => item.nat === `Card ${cardNumber}`
                            );
                          return (
                            <div
                              key={cardNumber}
                              className={`casino-odds-box back ${
                                remainingTime <= 3 || cardData?.gstatus == "SUSPENDED"
                                  ? "suspended-box"
                                  : "cursor-pointer hover:bg-blue-400"
                              }`}
                              onClick={() => {
                                if (
                                  remainingTime > 3 &&
                                  cardData?.gstatus !== "SUSPENDED"
                                ) {
                                  setPlaceBet(true);
                                  const newBetData = {
                                    betName: `Card ${cardNumber} - Odd`,
                                    boxColor: "bg-[#72bbef]",
                                    matchOdd: cardData?.b1,
                                    stake: 0,
                                    mid: cardData?.[0]?.mid,
                                    sid: cardData?.sid,
                                    oddType: "casino_odds",
