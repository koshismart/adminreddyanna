...
console.log("casino ka data",casinoData)
  ...
  <div className="one-card-meter casino-detail">
        ...
        {Array.isArray(oddsData) &&
          oddsData
            ...
            .map((item, index) => {
              ...
              return (
                <div className="meter-btn" key={item?.sid || index}>
                  <div
                    className={`meter-btn-box ${
                      isSuspended ? "suspended-box" : ""
                    }`}
                  >
                    <button className="btn btn-fighter-1 back">
                      Fighter A

                      {/* Always Show Image (No Value) */}
                      <img
                        src="https://g1ver.sprintstaticdata.com/v79/static/front/img/fight.png"
                        alt="Fight"
            ...
            .map((item, index) => {
              ...
              return (
                <div className="meter-btn" key={item?.sid || index}>
                  ...
                  >
                    <button className="btn btn-fighter-2 back">
                  ...
                  <div className="modal-body p-4">
                    ...
                    {individualResultData ? (
                      ...
                      <div className="casino-result-modal">
                        ...
                        <div>Winner</div>
                        <div>{individualResultData?.win == "1" ? "Fighter A" : "Fighter B"}</div>
                        </div>
                        <div className="casino-result-desc-item">
                        <div>Points</div>
                        <div>{individualResultData?.newdesc}</div>
                        </div>
                        </div>
                        </div>
                        </div>
