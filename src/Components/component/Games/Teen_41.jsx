...
const Teen_41 = ({
  ...
  const playerA = useMemo(() => {
    return oddsData.find(o => o.sid == "1");
  }, [oddsData])
  const playerB = useMemo(() => {
    return oddsData.find(o => o.sid == "2");
  }, [oddsData])
  const under = useMemo(() => {
    return oddsData.find(o => o.sid == "3");
  }, [oddsData])
  const over = useMemo(() => {
    return oddsData.find(o => o.sid == "4");
  }, [oddsData, casinoData])
                    ...
                    <div className="casino-table-body">
                      {playerB &&
                        <div className="casino-table-row" >
                          ...
                          <div className={`casino-odds-box back ${playerB.gstatus === "SUSPENDED" ? "suspended-box" : ""
                            }`}
                          >
                      ...
                      <div className="casino-table-row under-over-row">
                        <div className="uo-box">
                          ...
                          <div className={`casino-odds-box back ${under?.gstatus === "SUSPENDED" ? "suspended-box" : ""
                            }`}
                          >
                            {under && (under?.gstatus == "SUSPENDED" || remainingTime <= 3) ? (
                              <span className="casino-odds">{"0"}</span>
                            ) : (
                              <span
                                className="casino-odds cursor-pointer hover:text-blue-700"
                                onClick={() => {
                                  ...
                                  setPlaceBet(true);
                                  const newBetData = {
                                    betName: "Bet on " + under?.nat,
                                    boxColor: "bg-[#B2D6F0]",
                                    matchOdd: calculateCasinoRate(under?.b1),
                                    stake: 0,
                                    mid: under?.mid,
                                    sid: under?.sid,
                                    oddType: "casino_odds",
                        ...
                        <div className="uo-box">
                          ...
                          <div className={`casino-odds-box back ${over?.gstatus === "SUSPENDED" ? "suspended-box" : ""
                            }`}
                          >
                            {over && (over?.gstatus == "SUSPENDED" || remainingTime <= 3) ? (
                              <span className="casino-odds">{"0"}</span>
                            ) : (
                              <span
                                className="casino-odds cursor-pointer hover:text-blue-700"
                                onClick={() => {
                                  ...
                                  setPlaceBet(true);
                                  const newBetData = {
                                    betName: "Bet on " + over?.nat,
                                    boxColor: "bg-[#B2D6F0]",
                                    matchOdd: calculateCasinoRate(over?.b1),
                                    stake: 0,
                                    mid: over?.mid,
                                    sid: over?.sid,
                                    oddType: "casino_odds",
                        ...
                        <div className="casino-result-modal">
                          ...
                          <div className="row mt-4 justify-center">
                            <div className="col-md-6">
                              ...
                              <div className="casino-result-desc p-2 border rounded">
                                <div className="casino-result-desc-item flex justify-between">
                                  <div>Under/Over:</div>
